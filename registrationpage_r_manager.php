...
if($_POST){
    ...
    $sql="INSERT INTO restaurantregistration VALUES(
        Null,
        '$email',
        '$name',
        '$mobno',
 ...
 <nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#">Resturant Registration</a>
    </div>
  ...
  <!-- Nave code end -->
  <form action="registrationpage_r_manager.php" method="POST" name="myForm" onsubmit="return validateForm()">
    ...
    <div class="form-group">
      <label for="pwd">Resturant Name:</label>
      <input type="text" class="form-control" id="user" placeholder="Enter full name" name="r_name" required="">
    </div>
    <div class="form-group">
      <label for="pwd">Resturant Type:</label>
    ...
    <a href="http://localhost/internshala-resturant/loginpage.php" class="btn btn-info" role="button">Login</a>
  </form>
  <br>
